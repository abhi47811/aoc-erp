    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/suppliers" aria-label="Back to suppliers" className="p-2 -ml-2 text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors">
        ...
        {!isNew && (
          <button onClick={() => { setDeleteError(null); setConfirmDelete(true) }} aria-label="Delete supplier" className="p-2 text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
