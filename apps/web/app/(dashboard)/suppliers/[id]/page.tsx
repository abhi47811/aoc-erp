  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center justify-between">
        ...
        {!isNew && (
          <button onClick={() => { setDeleteError(null); setConfirmDelete(true) }} aria-label="Delete supplier" className="p-2 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
